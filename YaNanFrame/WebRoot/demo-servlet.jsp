			...
			<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
							<p>
								<h4><b id="tip">接口：getAllServlet.do</b></h4>
							</p>
    			...
    			amTable = $('#datatable-icons').DataTable({
			        ...
			        columnDefs:[{
				    	"render":function(data,type,row){
				    		if(data==4280)return "<a style='color:#92278f'>OUTPUT</a>";
				    		if(data==4281)return "<a style='color:#080'>FORWARD</a>";
				    		if(data==4282)return "<a style='color:#F00'>REDIRECT</a>";
				    		return "未知";
				    	},
				    	"targets":5,
				    }],
