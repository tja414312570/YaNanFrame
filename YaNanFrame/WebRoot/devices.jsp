			...
			<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content">
							<p>
								<h4><b id="tip"></b>上次同步时间 <b id="async_time">0000-00-00 00:00:00</b>，<a id="refresh">立即同步<i class="fa fa-refresh"></i></a></h4>
							</p>
      ...
      $(document).ready(function(){
    	...
    	$(document).ready(function() {
    		 auditEditor = new $.fn.dataTable.Editor( {
		        ...
		        idSrc:  'deviceId',
		        fields: [{
		                label:"设备名称(DeviceName):",
		                name: "deviceName"
		            },{
		                label:"设备数量(DeviceNum):",
		                name: "applayNum",
		            },{
		                label:"设备备注(note):",
		                name: "note",
    			...
    			amTable = $('#datatable-icons').DataTable({
			        ...
			        columnDefs:[{
				    	"render":function(data,type,row){
				    		if(data==4280)return "<a style='color:#92278f'>设备未激活</a>";
