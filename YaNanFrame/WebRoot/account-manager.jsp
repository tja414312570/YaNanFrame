			    	...
			    	$(document).ready(function() {
					     ...
					     //.   ajax: "ufo_member/addUfoMember.do",
			    			...
			    			amTable = $('#datatable-icons').dataTable({
						        ...
						        buttons: [
						       	    { extend: "create", text:"添加账号",  editor: auditEditor },
							        ...
							        { extend:'excelHtml5',title: '娱乐机器人账号信息'},
							        { extend:'csvHtml5', title: '娱乐机器人账号信息'},
							        { extend:"pdfHtml5", download: 'open'},
							        { extend:"print",text:"打印" , exportOptions: {columns: ':visible'},title:"娱乐机器人账号信息"},
							        { extend: 'print',text: '打印已选择',exportOptions: {modifier: {selected: true}},title:"娱乐机器人账号信息"},
