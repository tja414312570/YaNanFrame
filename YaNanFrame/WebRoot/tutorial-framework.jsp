				...
				<div class="col-sm-12 col-md-12">
					<div class="block-flat">
						...
						<div class="content">
							...
							<pre><code bind-url="codes/helloworld-servlet.code"></code></pre>
							
							<h4><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">1）、action注解的使用（@Action)</font></font></h4>
							<pre><code class="hljs java" bind-url="codes/base-servlet.code" bind-success="hljs.initHighlightingOnLoad();"></code></pre>
							
							<h4><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">2）、result注解的使用（@Result)</font></font></h4>
							<pre><code class="hljs java" bind-url="codes/result-servlet.code" bind-success="hljs.initHighlightingOnLoad();"></code></pre>
							
							<h4><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">3)、TokenServlet的使用</font></font></h4>
							<pre><code class="hljs java" bind-url="codes/token-servlet.code" bind-success="hljs.initHighlightingOnLoad();"></code></pre>
						</div>
					</div>
				</div>
			</div>
