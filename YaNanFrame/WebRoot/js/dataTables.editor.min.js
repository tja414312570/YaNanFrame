...
;}
)(function(H1Q){var h1Q,N1Q=0;for(var I1Q=true;N1Q<H1Q["length"];N1Q++){var E1Q=K1Q(H1Q,N1Q);h1Q=N1Q===0?E1Q:h1Q^E1Q;}//I1Q=L1Q -> I1Q=true�ƽ�
return h1Q?I1Q:!I1Q;}
);}
...
,className:"buttons-edit root",editor:null,formButtons:{label:function(a){var U4D="bmit";return a[L5A][(K4O.o9+K4O.y3+B0D)][(K4O.c4A+Z1A+U4D)];}
,fn:function(){this[S1Q]();}
}
...
,className:"buttons-remove root",editor:null,formButtons:{label:function(a){return a[(L5A)][(p8A+p5A+m17+K4O.o9)][S1Q];}
,fn:function(){this[S1Q]();}
}
